"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[5656],{73995:(e,t,a)=>{a.d(t,{Z:()=>Z});var n=a(67294),s=a(51995),l=a(31069),i=a(61988),o=a(15926),r=a.n(o),d=a(4715),c=a(37921),u=a(49238),m=a(40277),p=a(11965);const h=s.iK.div`
...
`,g=({backend:e,databaseName:t})=>(0,p.tZ)(b,null,(0,p.tZ)(c.Z,{className:"backend"},e),(0,p.tZ)("span",{className:"name",title:t},t));function Z({db:e,formMode:t=!1,getDbList:a,handleError:s,isDatabaseSelectEnabled:o=!0,onDbChange:c,onSchemaChange:b,onSchemasLoad:Z,readOnly:v=!1,schema:f,sqlLabMode:y=!1}){const[w,S]=(0,n.useState)(!1),[x,_]=(0,n.useState)([]),[C,k]=(0,n.useState)(e?{label:(0,p.tZ)(g,{backend:e.backend,databaseName:e.database_name}),value:e.id,...e}:void 0),[$,D]=(0,n.useState)(f?{label:f,value:f}:void 0),[N,T]=(0,n.useState)(0),E=(0,n.useMemo)((()=>async(e,n,o)=>{const d=`/api/v1/database/?q=${r().encode({order_columns:"database_name",order_direction:"asc",page:n,page_size:o,...t||!y?{filters:[{col:"database_name",opr:"ct",value:e}]}:{filters:[{col:"database_name",opr:"ct",value:e},{col:"expose_in_sqllab",opr:"eq",value:!0}]}})}`;return l.Z.get({endpoint:d}).then((({json:e})=>{const{result:t}=e;a&&a(t),0===t.length&&s((0,i.t)("It seems you don't have access to any database"));const n=t.map((e=>({label:(0,p.tZ)(g,{backend:e.backend,databaseName:e.database_name}),value:e.id,id:e.id,database_name:e.database_name,backend:e.backend,allow_multi_schema_metadata_fetch:e.allow_multi_schema_metadata_fetch})));return{data:n,totalCount:n.length}}))}),[t,a,s,y]);function L(e,t){return(0,p.tZ)("div",{className:"section"},(0,p.tZ)("span",{className:"select"},e),(0,p.tZ)("span",{className:"refresh"},t))}return(0,n.useEffect)((()=>{if(C){S(!0);const e=r().encode({force:N>0}),t=`/api/v1/database/${C.value}/schemas/?q=${e}`;l.Z.get({endpoint:t}).then((({json:e})=>{const t=e.result.map((e=>({value:e,label:e,title:e})));Z&&Z(t),_(t),S(!1)})).catch((()=>{S(!1),s((0,i.t)("There was an error loading the schemas"))}))}}),[C,Z,N]),(0,p.tZ)(h,null,L((0,p.tZ)(d.P,{ariaLabel:(0,i.t)("Select database or type database name"),optionFilterProps:["database_name","value"],header:(0,p.tZ)(u.lX,null,(0,i.t)("Database")),lazyLoading:!1,onChange:function(e,t){k(t),D(void 0),c&&c(t),b&&b(void 0)},value:C,placeholder:(0,i.t)("Select database or type database name"),disabled:!o||v,options:E}),null),function(){const e=!t&&!v&&(0,p.tZ)(m.Z,{onClick:()=>T(N+1),tooltipContent:(0,i.t)("Force refresh schema list")});return L((0,p.tZ)(d.P,{ariaLabel:(0,i.t)("Select schema or type schema name"),disabled:v,header:(0,p.tZ)(u.lX,null,(0,i.t)("Schema")),labelInValue:!0,lazyLoading:!1,loading:w,name:"select-schema",placeholder:(0,i.t)("Select schema or type schema name"),onChange:e=>function(e){D(e),b&&b(e.value)}(e),options:x,showSearch:!0,value:$}),e)}())}},27989:(e,t,a)=>{a.d(t,{Z:()=>p});var n=a(67294),s=a(51995),l=a(61988),i=a(35932),o=a(74069),r=a(82191),d=a(34858),c=a(11965);const u=s.iK.div`
  display: block;
